    ...
    <form action="{{ route('admin.restaurants.update', $restaurant->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <img src="{{ $restaurant->image_url }}" alt="{{ $restaurant->name }}" 
                 style="max-width: 300px; border-radius: 10px; border: 2px solid var(--card-border); margin-bottom: 0.5rem;">
            <br>
            <button type="button" onclick="if(confirm('Hapus foto ini?')) document.getElementById('deleteImageForm').submit();" 
        ...
        <div style="margin-bottom: 1.5rem;">
            <label style="display: block; margin-bottom: 0.5rem; font-weight: 600;">
                @if($restaurant->image) Ganti @else Upload @endif Foto Restoran
            </label>
...
@if($restaurant->image)
<form id="deleteImageForm" action="{{ route('admin.restaurants.deleteImage', $restaurant->id) }}" method="POST" style="display: none;">
    @csrf
    @method('DELETE')
</form>
@endif
